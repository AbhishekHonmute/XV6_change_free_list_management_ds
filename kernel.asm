...
801025ab:	00 00 00 
  kmem.free_mem = 0;
801025ae:	c7 05 78 26 11 80 00 	movl   $0x0,0x80112678
801025b5:	00 00 00 
  p = (char*)PGROUNDUP((uint)vstart);
...
80102667:	83 ec 18             	sub    $0x18,%esp
  ...
  if(kmem.use_lock)
8010266a:	8b 0d 74 26 11 80    	mov    0x80112674,%ecx
80102670:	85 c9                	test   %ecx,%ecx
80102672:	75 4c                	jne    801026c0 <kalloc+0x60>
    acquire(&kmem.lock);
  // r = kmem.freelist;
...
8010267b:	74 5b                	je     801026d8 <kalloc+0x78>
...
8010267d:	8b 15 74 26 11 80    	mov    0x80112674,%edx
  kmem.free_mem -= 1;
80102683:	83 e8 01             	sub    $0x1,%eax
80102686:	a3 78 26 11 80       	mov    %eax,0x80112678
  fl = freelist_arr[kmem.free_mem];
8010268b:	8b 04 85 80 26 11 80 	mov    -0x7feed980(,%eax,4),%eax
  if(kmem.use_lock)
80102692:	85 d2                	test   %edx,%edx
80102694:	75 0a                	jne    801026a0 <kalloc+0x40>
    release(&kmem.lock);
  return (char*)fl;
}
80102696:	c9                   	leave  
...
801026a6:	68 40 26 11 80       	push   $0x80112640
801026ab:	e8 c0 1f 00 00       	call   80104670 <release>
...
801026c8:	e8 e3 1e 00 00       	call   801045b0 <acquire>
801026cd:	83 c4 10             	add    $0x10,%esp
801026d0:	eb a2                	jmp    80102674 <kalloc+0x14>
801026d2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    release(&kmem.lock);
801026d8:	83 ec 0c             	sub    $0xc,%esp
801026db:	68 40 26 11 80       	push   $0x80112640
801026e0:	e8 8b 1f 00 00       	call   80104670 <release>
    return 0;
